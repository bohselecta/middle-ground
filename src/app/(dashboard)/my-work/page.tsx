  ...
  return (
    <div className="p-6">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
              <h1 className="text-3xl font-semibold tracking-tight text-slate-900">My Work</h1>
              <p className="mt-2 text-lg text-slate-600">
                Log how it's going. Spot patterns that help you work better.
              </p>
        </div>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white/70 p-6 shadow-soft">
                <h3 className="text-lg font-medium text-slate-900 mb-4">Your Patterns</h3>
          ...
          <div className="rounded-2xl bg-white/70 p-6 shadow-soft">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-slate-500">
                Leaders see trends, not your notes.
              </p>
            </div>
          </div>
