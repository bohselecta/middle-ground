  ...
  return (
    <div className="p-6">
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
              <h1 className="text-3xl font-semibold tracking-tight text-slate-900">Team Overview</h1>
              <p className="mt-2 text-lg text-slate-600">
                Anonymous trends that show gaps and wins.
              </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="lg:col-span-1">
            <div className="rounded-2xl bg-white/70 p-6 shadow-soft">
              <h3 className="text-lg font-medium text-slate-900 mb-4">Highlights</h3>
              {isLoading ? (
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white/70 p-6 shadow-soft">
            <h3 className="text-lg font-medium text-slate-900 mb-4">Decision Log</h3>
            <div className="space-y-3">
